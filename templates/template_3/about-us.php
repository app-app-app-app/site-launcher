...
<section class="welcome" aria-labelledby="welcome-title">
    ...
    <p style="text-align: center; max-width: 1000px; margin: 0 auto;" class="leaders__description"><?= $about_paragraph_1 ?></p>
    <br>
    ...
    <br>
    <p style="text-align: center; max-width: 1000px; margin: 0 auto;" class="leaders__description"><?= $about_paragraph_4 ?></p>
    <br>
    <p style="text-align: center; max-width: 1000px; margin: 0 auto;" class="leaders__description"><?= $about_paragraph_5 ?></p>
    <br>
    <p style="text-align: center; max-width: 1000px; margin: 0 auto;" class="leaders__description"><?= $about_paragraph_6 ?></p>
    <br>
    <p style="text-align: center; max-width: 1000px; margin: 0 auto;" class="leaders__description"><?= $about_paragraph_7 ?></p>
</section>
