...
<h1 class="heading-style-h1" style="text-align: center;"><?= $terms_heading ?></h1>

<p class="text-size-regular" style="text-align: center;"><?= $terms_text_1 ?></p>
<p class="text-size-regular" style="text-align: center;"><?= $terms_text_2 ?></p>
<p class="text-size-regular" style="text-align: center;"><?= $terms_text_3 ?></p>
<p class="text-size-regular" style="text-align: center;"><?= $terms_text_4 ?></p>
<p class="text-size-regular" style="text-align: center;"><?= $terms_text_5 ?></p>
<p class="text-size-regular" style="text-align: center;"><?= $terms_text_6 ?></p>
<p class="text-size-regular" style="text-align: center;"><?= $terms_text_7 ?></p>
<p class="text-size-regular" style="text-align: center;"><?= $terms_text_8 ?></p>
