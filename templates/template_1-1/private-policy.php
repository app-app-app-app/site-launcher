...
<title><?= $page_title_private ?></title>
<meta property="og:type" content="website" />
<meta name="description" content="<?= $page_description_private ?>">
...
<h1 class="heading-style-h1" style="text-align: center;"><?= $private_policy_heading ?></h1>

<p class="text-size-regular" style="text-align: center;">
  <?= $private_policy_intro ?>
</p>

<h3 class="heading-style-h4" style="margin-top: 40px;"><?= $private_policy_section_1_heading ?></h3>
<p class="text-size-regular" style="text-align: center;">
  <?= $private_policy_section_1_text ?>
</p>

<h3 class="heading-style-h4" style="margin-top: 40px;"><?= $private_policy_section_2_heading ?></h3>
<p class="text-size-regular" style="text-align: center;">
  <?= $private_policy_section_2_text ?>
</p>
<ul>
<?php foreach($private_policy_section_2_list as $item): ?>
  <li><?= $item ?></li>
<?php endforeach; ?>
</ul>
<p class="text-size-regular" style="text-align: center;">
  <?= $private_policy_section_2_note ?>
</p>

<h3 class="heading-style-h4" style="margin-top: 40px;"><?= $private_policy_section_3_heading ?></h3>
<p class="text-size-regular" style="text-align: center;">
  <?= $private_policy_section_3_text ?>
</p>
<ul>
<?php foreach($private_policy_section_3_list as $item): ?>
  <li><?= $item ?></li>
<?php endforeach; ?>
</ul>

<h3 class="heading-style-h4" style="margin-top: 40px;"><?= $private_policy_section_4_heading ?></h3>
<p class="text-size-regular" style="text-align: center;">
  <?= $private_policy_section_4_text ?>
</p>
<ul>
<?php foreach($private_policy_section_4_list as $item): ?>
  <li><?= $item ?></li>
<?php endforeach; ?>
</ul>

<h3 class="heading-style-h4" style="margin-top: 40px;"><?= $private_policy_section_5_heading ?></h3>
<ul>
<?php foreach($private_policy_section_5_list as $item): ?>
  <li><?= $item ?></li>
<?php endforeach; ?>
</ul>

<h3 class="heading-style-h4" style="margin-top: 40px;"><?= $private_policy_section_6_heading ?></h3>
<p class="text-size-regular" style="text-align: center;">
  <?= $private_policy_section_6_text ?>
</p>
<ul>
<?php foreach($private_policy_section_6_list as $item): ?>
  <li><?= $item ?></li>
<?php endforeach; ?>
</ul>
<p class="text-size-regular" style="text-align: center;">
  <?= $private_policy_section_6_note ?>
</p>

<h3 class="heading-style-h4" style="margin-top: 40px;"><?= $private_policy_section_7_heading ?></h3>
<p class="text-size-regular" style="text-align: center;">
  <?= $private_policy_section_7_text ?>
</p>

<h3 class="heading-style-h4" style="margin-top: 40px;"><?= $private_policy_section_8_heading ?></h3>
<p class="text-size-regular" style="text-align: center;">
  <?= $private_policy_section_8_text ?>
</p>
<ul>
<?php foreach($private_policy_section_8_list as $item): ?>
  <li><?= $item ?></li>
<?php endforeach; ?>
</ul>
<p class="text-size-regular" style="text-align: center;">
  <?= $private_policy_section_8_note ?>
</p>

<h3 class="heading-style-h4" style="margin-top: 40px;"><?= $private_policy_section_9_heading ?></h3>
<p class="text-size-regular" style="text-align: center;">
  <?= $private_policy_section_9_text ?>
</p>
<ul>
<?php foreach($private_policy_section_9_list as $item): ?>
  <li><?= $item ?></li>
<?php endforeach; ?>
</ul>
<p class="text-size-regular" style="text-align: center;">
  <?= $private_policy_section_9_note ?>
</p>

<h3 class="heading-style-h4" style="margin-top: 40px;"><?= $private_policy_section_10_heading ?></h3>
<p class="text-size-regular" style="text-align: center;">
  <?= $private_policy_section_10_text ?>
</p>
<ul>
<?php foreach($private_policy_section_10_list as $item): ?>
  <li><?= $item ?></li>
<?php endforeach; ?>
</ul>

<h3 class="heading-style-h4" style="margin-top: 40px;"><?= $private_policy_section_11_heading ?></h3>
<p class="text-size-regular" style="text-align: center;">
...
<p class="text-size-regular" style="text-align: center;">
  <?= $private_policy_section_12_text ?>
</p>

<h3 class="heading-style-h4" style="margin-top: 40px;"><?= $private_policy_section_13_heading ?></h3>
<p class="text-size-regular" style="text-align: center;">
...
<p style="text-align: center;">
  <?= $private_policy_agreement ?>
</p>
<p style="text-align: center;">
  <?= $private_policy_thank_you ?>
</p>
