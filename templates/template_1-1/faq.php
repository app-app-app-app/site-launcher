...
<meta name="description" content="<?= $page_description_faq ?>">
...
<h1 class="heading-style-h1" style="text-align: center;"><?= $faq_page_heading ?></h1>

<h3 class="heading-style-h4" style="text-align: center; margin-top: 10px;"><?= $faq_page_subheading ?></h3>

<p class="text-size-regular" style="text-align: center;"><?= $faq_page_intro_1 ?></p>
<p class="text-size-regular" style="text-align: center;"><?= $faq_page_intro_2 ?></p>
<p class="text-size-regular" style="text-align: center;"><?= $faq_page_intro_3 ?></p>
...
<h2 class="heading-style-h3" style="font-weight: bold;"><?= $faq_page_section_heading ?></h2>
                                </div>
                            </div>
